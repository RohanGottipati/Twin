...
export function Legend() {
  return (
 <div className="border border-white/[0.07] bg-black/50 px-2.5 py-2 backdrop-blur-md">
      <div className="flex items-center gap-1.5">
        ...
        <span
          aria-hidden
 className="h-[4px] w-16 opacity-80"
          style={{
 ...
 <span aria-hidden className="h-[2px] w-3 bg-[#e0cb3c]"/>
          <span className="font-mono text-[7.5px] uppercase tracking-wide text-muted/70">subway</span>
        </span>
        <span className="flex items-center gap-1">
 <span aria-hidden className="h-[2px] w-3 bg-[#7f6ff0]"/>
